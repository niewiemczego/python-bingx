...
class _HTTPManager:
    ...
    def __generate_signature(self, query_string: str) -> str:
        """
    ...
    def __generate_query_string(self, payload: dict[str, Any]) -> str:
        """
        ...
        query_string += f"&signature={self.__generate_signature(query_string)}"
        return query_string

    def __request(self, method: str, endpoint: str, payload: dict[str, Any] | None = None, headers: dict[str, Any] | None = None) -> requests.Response:
        """
        ...
        url = f"{self.__BASE_URL}{endpoint}?{self.__generate_query_string(payload)}"
        match method:
            case "GET":
            ...
            case "PUT":
                req = requests.request("PUT", url, headers=self.headers)
            case "DELETE":
    ...
    def _get(self, endpoint: str, payload: dict[str, Any] | None = None, headers: dict[str, Any] | None = None) -> requests.Response:
        """
        ...
        return self.__request("GET", endpoint, payload, headers)

    def _post(self, endpoint: str, payload: dict[str, Any] | None = None, headers: dict[str, Any] | None = None) -> requests.Response:
        """
        ...
        return self.__request("POST", endpoint, payload, headers)

    def _put(self, endpoint: str, payload: dict[str, Any] | None = None, headers: dict[str, Any] | None = None) -> requests.Response:
        """
        ...
        return self.__request("PUT", endpoint, payload, headers)

    def _delete(self, endpoint: str, payload: dict[str, Any] | None = None, headers: dict[str, Any] | None = None) -> requests.Response:
        """
        ...
        return self.__request("DELETE", endpoint, payload, headers)